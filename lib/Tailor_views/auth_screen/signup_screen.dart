...
import 'package:dashboard/view/verify_email.dart';
...
class SignupScreen_Tailor extends StatefulWidget {
  final String type;
  const SignupScreen_Tailor({required this.type, Key? key}) : super(key: key);
                  ...
                  children: [
                    ...
                    Obx(
                      () => Column(
                        children: [
                          customTextField(
                              name, nameHint, nameController, false),
                          customTextField(
                          ...
                          customTextField(
                              phone, phoneHint, phoneController, false),
                          customTextField(
                              Cnic, cnicHint, cnicController, false),
                          5.heightBox,
                          Row(
                            children: [
                              Checkbox(
