...
import 'package:dashboard/view/verify_email_customer.dart';
...
class SignupScreen extends StatefulWidget {
  final String type;
  const SignupScreen({required this.type, Key? key}) : super(key: key);
                                  ...
                                  try {
                                    await controller
                                     ...
                                     // VxToast.show(context, msg: logedin);
                                      Get.offAll(() => const VerifyEmailScreen_cust());
                                    });
                                  } catch (e) {
                                    auth.signOut();
